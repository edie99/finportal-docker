...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    protected function getCache_AppService()
    {
        ...
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('r5a2Whuyba', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('RhU49yOp-c', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ovXygGUyhX', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolder41166 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer22909 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties24311 = [
        
    ];

    public function getConnection()
    {
        $this->initializer22909 && ($this->initializer22909->__invoke($valueHolder41166, $this, 'getConnection', array(), $this->initializer22909) || 1) && $this->valueHolder41166 = $valueHolder41166;

        return $this->valueHolder41166->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializer22909 && ($this->initializer22909->__invoke($valueHolder41166, $this, 'getMetadataFactory', array(), $this->initializer22909) || 1) && $this->valueHolder41166 = $valueHolder41166;

        return $this->valueHolder41166->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializer22909 && ($this->initializer22909->__invoke($valueHolder41166, $this, 'getExpressionBuilder', array(), $this->initializer22909) || 1) && $this->valueHolder41166 = $valueHolder41166;

        return $this->valueHolder41166->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializer22909 && ($this->initializer22909->__invoke($valueHolder41166, $this, 'beginTransaction', array(), $this->initializer22909) || 1) && $this->valueHolder41166 = $valueHolder41166;

        return $this->valueHolder41166->beginTransaction();
    }

    public function getCache()
    {
        $this->initializer22909 && ($this->initializer22909->__invoke($valueHolder41166, $this, 'getCache', array(), $this->initializer22909) || 1) && $this->valueHolder41166 = $valueHolder41166;

        return $this->valueHolder41166->getCache();
    }

    public function transactional($func)
    {
        $this->initializer22909 && ($this->initializer22909->__invoke($valueHolder41166, $this, 'transactional', array('func' => $func), $this->initializer22909) || 1) && $this->valueHolder41166 = $valueHolder41166;

        return $this->valueHolder41166->transactional($func);
    }

    public function wrapInTransaction(callable $func)
    {
        $this->initializer22909 && ($this->initializer22909->__invoke($valueHolder41166, $this, 'wrapInTransaction', array('func' => $func), $this->initializer22909) || 1) && $this->valueHolder41166 = $valueHolder41166;

        return $this->valueHolder41166->wrapInTransaction($func);
    }

    public function commit()
    {
        $this->initializer22909 && ($this->initializer22909->__invoke($valueHolder41166, $this, 'commit', array(), $this->initializer22909) || 1) && $this->valueHolder41166 = $valueHolder41166;

        return $this->valueHolder41166->commit();
    }

    public function rollback()
    {
        $this->initializer22909 && ($this->initializer22909->__invoke($valueHolder41166, $this, 'rollback', array(), $this->initializer22909) || 1) && $this->valueHolder41166 = $valueHolder41166;

        return $this->valueHolder41166->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializer22909 && ($this->initializer22909->__invoke($valueHolder41166, $this, 'getClassMetadata', array('className' => $className), $this->initializer22909) || 1) && $this->valueHolder41166 = $valueHolder41166;

        return $this->valueHolder41166->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializer22909 && ($this->initializer22909->__invoke($valueHolder41166, $this, 'createQuery', array('dql' => $dql), $this->initializer22909) || 1) && $this->valueHolder41166 = $valueHolder41166;

        return $this->valueHolder41166->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializer22909 && ($this->initializer22909->__invoke($valueHolder41166, $this, 'createNamedQuery', array('name' => $name), $this->initializer22909) || 1) && $this->valueHolder41166 = $valueHolder41166;

        return $this->valueHolder41166->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializer22909 && ($this->initializer22909->__invoke($valueHolder41166, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer22909) || 1) && $this->valueHolder41166 = $valueHolder41166;

        return $this->valueHolder41166->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializer22909 && ($this->initializer22909->__invoke($valueHolder41166, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer22909) || 1) && $this->valueHolder41166 = $valueHolder41166;

        return $this->valueHolder41166->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializer22909 && ($this->initializer22909->__invoke($valueHolder41166, $this, 'createQueryBuilder', array(), $this->initializer22909) || 1) && $this->valueHolder41166 = $valueHolder41166;

        return $this->valueHolder41166->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializer22909 && ($this->initializer22909->__invoke($valueHolder41166, $this, 'flush', array('entity' => $entity), $this->initializer22909) || 1) && $this->valueHolder41166 = $valueHolder41166;

        return $this->valueHolder41166->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializer22909 && ($this->initializer22909->__invoke($valueHolder41166, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer22909) || 1) && $this->valueHolder41166 = $valueHolder41166;

        return $this->valueHolder41166->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializer22909 && ($this->initializer22909->__invoke($valueHolder41166, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer22909) || 1) && $this->valueHolder41166 = $valueHolder41166;

        return $this->valueHolder41166->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializer22909 && ($this->initializer22909->__invoke($valueHolder41166, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer22909) || 1) && $this->valueHolder41166 = $valueHolder41166;

        return $this->valueHolder41166->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializer22909 && ($this->initializer22909->__invoke($valueHolder41166, $this, 'clear', array('entityName' => $entityName), $this->initializer22909) || 1) && $this->valueHolder41166 = $valueHolder41166;

        return $this->valueHolder41166->clear($entityName);
    }

    public function close()
    {
        $this->initializer22909 && ($this->initializer22909->__invoke($valueHolder41166, $this, 'close', array(), $this->initializer22909) || 1) && $this->valueHolder41166 = $valueHolder41166;

        return $this->valueHolder41166->close();
    }

    public function persist($entity)
    {
        $this->initializer22909 && ($this->initializer22909->__invoke($valueHolder41166, $this, 'persist', array('entity' => $entity), $this->initializer22909) || 1) && $this->valueHolder41166 = $valueHolder41166;

        return $this->valueHolder41166->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializer22909 && ($this->initializer22909->__invoke($valueHolder41166, $this, 'remove', array('entity' => $entity), $this->initializer22909) || 1) && $this->valueHolder41166 = $valueHolder41166;

        return $this->valueHolder41166->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializer22909 && ($this->initializer22909->__invoke($valueHolder41166, $this, 'refresh', array('entity' => $entity), $this->initializer22909) || 1) && $this->valueHolder41166 = $valueHolder41166;

        return $this->valueHolder41166->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializer22909 && ($this->initializer22909->__invoke($valueHolder41166, $this, 'detach', array('entity' => $entity), $this->initializer22909) || 1) && $this->valueHolder41166 = $valueHolder41166;

        return $this->valueHolder41166->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializer22909 && ($this->initializer22909->__invoke($valueHolder41166, $this, 'merge', array('entity' => $entity), $this->initializer22909) || 1) && $this->valueHolder41166 = $valueHolder41166;

        return $this->valueHolder41166->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializer22909 && ($this->initializer22909->__invoke($valueHolder41166, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer22909) || 1) && $this->valueHolder41166 = $valueHolder41166;

        return $this->valueHolder41166->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializer22909 && ($this->initializer22909->__invoke($valueHolder41166, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer22909) || 1) && $this->valueHolder41166 = $valueHolder41166;

        return $this->valueHolder41166->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializer22909 && ($this->initializer22909->__invoke($valueHolder41166, $this, 'getRepository', array('entityName' => $entityName), $this->initializer22909) || 1) && $this->valueHolder41166 = $valueHolder41166;

        return $this->valueHolder41166->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializer22909 && ($this->initializer22909->__invoke($valueHolder41166, $this, 'contains', array('entity' => $entity), $this->initializer22909) || 1) && $this->valueHolder41166 = $valueHolder41166;

        return $this->valueHolder41166->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializer22909 && ($this->initializer22909->__invoke($valueHolder41166, $this, 'getEventManager', array(), $this->initializer22909) || 1) && $this->valueHolder41166 = $valueHolder41166;

        return $this->valueHolder41166->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializer22909 && ($this->initializer22909->__invoke($valueHolder41166, $this, 'getConfiguration', array(), $this->initializer22909) || 1) && $this->valueHolder41166 = $valueHolder41166;

        return $this->valueHolder41166->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializer22909 && ($this->initializer22909->__invoke($valueHolder41166, $this, 'isOpen', array(), $this->initializer22909) || 1) && $this->valueHolder41166 = $valueHolder41166;

        return $this->valueHolder41166->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializer22909 && ($this->initializer22909->__invoke($valueHolder41166, $this, 'getUnitOfWork', array(), $this->initializer22909) || 1) && $this->valueHolder41166 = $valueHolder41166;

        return $this->valueHolder41166->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializer22909 && ($this->initializer22909->__invoke($valueHolder41166, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer22909) || 1) && $this->valueHolder41166 = $valueHolder41166;

        return $this->valueHolder41166->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializer22909 && ($this->initializer22909->__invoke($valueHolder41166, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer22909) || 1) && $this->valueHolder41166 = $valueHolder41166;

        return $this->valueHolder41166->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializer22909 && ($this->initializer22909->__invoke($valueHolder41166, $this, 'getProxyFactory', array(), $this->initializer22909) || 1) && $this->valueHolder41166 = $valueHolder41166;

        return $this->valueHolder41166->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializer22909 && ($this->initializer22909->__invoke($valueHolder41166, $this, 'initializeObject', array('obj' => $obj), $this->initializer22909) || 1) && $this->valueHolder41166 = $valueHolder41166;

        return $this->valueHolder41166->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializer22909 && ($this->initializer22909->__invoke($valueHolder41166, $this, 'getFilters', array(), $this->initializer22909) || 1) && $this->valueHolder41166 = $valueHolder41166;

        return $this->valueHolder41166->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializer22909 && ($this->initializer22909->__invoke($valueHolder41166, $this, 'isFiltersStateClean', array(), $this->initializer22909) || 1) && $this->valueHolder41166 = $valueHolder41166;

        return $this->valueHolder41166->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializer22909 && ($this->initializer22909->__invoke($valueHolder41166, $this, 'hasFilters', array(), $this->initializer22909) || 1) && $this->valueHolder41166 = $valueHolder41166;

        return $this->valueHolder41166->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializer22909 = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolder41166) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder41166 = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolder41166->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializer22909 && ($this->initializer22909->__invoke($valueHolder41166, $this, '__get', ['name' => $name], $this->initializer22909) || 1) && $this->valueHolder41166 = $valueHolder41166;

        if (isset(self::$publicProperties24311[$name])) {
            return $this->valueHolder41166->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder41166;
    ...
    {
        $this->initializer22909 && ($this->initializer22909->__invoke($valueHolder41166, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer22909) || 1) && $this->valueHolder41166 = $valueHolder41166;
    ...
    {
        $this->initializer22909 && ($this->initializer22909->__invoke($valueHolder41166, $this, '__isset', array('name' => $name), $this->initializer22909) || 1) && $this->valueHolder41166 = $valueHolder41166;
    ...
    {
        $this->initializer22909 && ($this->initializer22909->__invoke($valueHolder41166, $this, '__unset', array('name' => $name), $this->initializer22909) || 1) && $this->valueHolder41166 = $valueHolder41166;
    ...
    {
        $this->initializer22909 && ($this->initializer22909->__invoke($valueHolder41166, $this, '__clone', array(), $this->initializer22909) || 1) && $this->valueHolder41166 = $valueHolder41166;

        $this->valueHolder41166 = clone $this->valueHolder41166;
    }

    public function __sleep()
    {
        $this->initializer22909 && ($this->initializer22909->__invoke($valueHolder41166, $this, '__sleep', array(), $this->initializer22909) || 1) && $this->valueHolder41166 = $valueHolder41166;

        return array('valueHolder41166');
    }
    ...
    {
        $this->initializer22909 = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializer22909;
    }

    public function initializeProxy() : bool
    {
        return $this->initializer22909 && ($this->initializer22909->__invoke($valueHolder41166, $this, 'initializeProxy', array(), $this->initializer22909) || 1) && $this->valueHolder41166 = $valueHolder41166;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder41166;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder41166;
    }
}
